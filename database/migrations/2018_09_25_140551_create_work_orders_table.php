...
class CreateWorkOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('work_orders', function (Blueprint $table) {
            ...
            $table->tinyInteger('source')->nullable()->comment('客户来源,1:400电话,2:官网客服,3:百度信息流,4:今日头条信息流,5:app,6:PC,7:微信,8:小程序,9:58同城');
            ...
            $table->integer('recorder')->nullable()->comment('录入人');
            $table->softDeletes();
            $table->timestamps();
        });

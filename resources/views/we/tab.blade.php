<div id="alltab" style="display:flex;position:fixed;justify-content:space-around;background:white;height:49px;z-index:300;bottom:0;
    ...
    <a class="tabs" style="text-align:center" href="/">
        @if(Request::segment(1) !== null)<img src="{{res('/we_img/tab1.png')}}" style="height:22px;margin-bottom:-4px;">@endif
        @if(Request::segment(1) == null)<img src="{{res('/we_img/tab1_active.png')}}" style="height:22px;margin-bottom:-4px;">@endif
    ...
    <a class="tabs" style="text-align:center" href="/buildings">
        @if(Request::segment(1) !== 'buildings')<img src="{{res('/we_img/tab2.png')}}" style="height:22px;margin-bottom:-4px;">@endif
        @if(Request::segment(1) == "buildings")<img src="{{res('/we_img/tab2_active.png')}}" style="height:22px;margin-bottom:-4px;">@endif
    ...
    <a class="tabs" style="text-align:center" href="/servers">
        @if(Request::segment(1) !== 'servers')<img src="{{res('/we_img/tab3.png')}}" style="height:22px;margin-bottom:-4px;">@endif
        @if(Request::segment(1) == 'servers')<img src="{{res('/we_img/tab3_active.png')}}" style="height:22px;margin-bottom:-4px;">@endif
    ...
    <a class="tabs" style="text-align:center" href="/user">
        @if(Request::segment(1) !== 'user')<img src="{{res('/we_img/tab4.png')}}" style="height:22px;margin-bottom:-4px;" >@endif
        @if(Request::segment(1) == 'user')<img src="{{res('/we_img/tab4_active.png')}}" style="height:22px;margin-bottom:-4px;">@endif

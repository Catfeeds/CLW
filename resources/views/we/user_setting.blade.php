...
@section('body')
    <div class="mui-content">
        <div class="telNumber" id="reviseTel"><span>手机号码</span><a href="#" class="mui-pull-right"><span id="tel">{{session('user')->tel}}</span><img src="/we_img/house_detail_drop_down.png" ></a></div>

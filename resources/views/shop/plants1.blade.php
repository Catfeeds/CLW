    ...
    <div class="plant_container">
      ...
      <div class="plant_archives clearfix">
        ...
        <div class="plant_info f_r clearfix">
          ...
          <ul class="info_des f_l">
            <li class="des">红掌</li>
            <li class="des">火鹤、安祖花、红苞芋、花烛</li>
            <li class="des">阳台，客厅，办公桌</li>
            <li class="des">燃烧的心，热情，关心</li>
            <li class="des">喜欢湿度较高的环境</li>
            <li class="des">美观，净化空气，防辐射，除甲醛</li>
          </ul>
        </div>
      </div>
      <div class="knowledge">
      ...
      <div class="plant_put">
        ...
        <div class="plants_img">
          <img src="/shop_img/plants_img_red2.jpg" alt="">
          <img src="/shop_img/plants_img_red3.jpg" alt="">
          <img src="/shop_img/plants_img_red4.jpg" alt="">
        </div>
      </div>
      <div class="us_serve">

...
@section('body')
  ...
  <div class="proscenium_container">
    ...
    <!-- 前台描述部分 -->
    <div class="proscenium_des" style="background: url('{{shopRes('/shop_img/pantai_des.jpg')}}') no-repeat center;">
    ...
    <div class="proscenium_show">
      ...
      <div class="products">
        <div class="left">
          <img src="{{shopRes('/shop_img/pantai_show1.jpg')}}" alt="">
        </div>
        <div class="right">
          <div class="right_top">
            <img src="{{shopRes('/shop_img/pantai_show2.jpg')}}" alt="">
          </div>
          <div class="right_bottom">
            <img src="{{shopRes('/shop_img/pantai_show3.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>

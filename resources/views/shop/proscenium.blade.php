...
@section('header')
    <link rel="stylesheet" href="{{shopRes('/css/shop_proscenium.css')}}">
@endsection
@section('body')
  @include('shop.header')
  ...
  <div class="proscenium_container">
    ...
    <div class="banner" style="background: url('{{shopRes('/shop_img/proscenium_back.jpg')}}') no-repeat center;">
      <div class="title">办公家具 (<span class="page_name" style="font-size:60px">前台</span>)</div>
    ...
    <div class="proscenium_show">
      ...
      <div class="products">
        <div class="left">
          <img src="{{shopRes('/shop_img/product_left.jpg')}}" alt="">
        </div>
        <div class="right">
          <div class="right_top">
            <img src="{{shopRes('/shop_img/product_right_top.jpg')}}" alt="">
          </div>
          <div class="right_bottom">
            <img src="{{shopRes('/shop_img/product_right_bottom.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>

...
@section('title', '豪车租赁')
@section('header')
    <link rel="stylesheet" href="{{shopRes('/css/shop_rent_car.css')}}">
@endsection
@section('body')
    @include('shop.header')
    ...
    <div class="rentCar_container" style="box-sizing:border-box">
      ...
      <div class="banner" style="background: url('{{shopRes('/shop_img/car_banner.jpg')}}') no-repeat center;"></div>
      <div class="details">
        <div class="details_box">
          <div class="detail clearfix">
            <div class="detail_img f_l">
              <img src="{{shopRes('/shop_img/car_detail1.png')}}" alt="">
            </div>
          ...
          <div class="detail clearfix">
            <div class="detail_img f_l">
              <img src="{{shopRes('/shop_img/car_detail2.png')}}" alt="">
            </div>
            <div class="detail_des f_l">
          ...
          <div class="detail clearfix">
            <div class="detail_img f_l">
              <img src="{{shopRes('/shop_img/car_detail3.png')}}" alt="">
            </div>
            <div class="detail_des f_l">
        ...
        <div class="brand">
          <img src="{{shopRes('/shop_img/car_brand.png')}}" alt="">
        </div>
      </div>
      <div class="recommend">
        <div class="title">
        ...
        <div class="options">
          <div class="option">
            <img src="{{shopRes('/shop_img/car1.jpg')}}" alt="">
            <div class="name">
              马自达MX-5
            </div>
          </div>
          <div class="option">
            <img src="{{shopRes('/shop_img/car2.jpg')}}" alt="">
            <div class="name">
              法拉利 458 Italia红色
            </div>
          </div>
          <div class="option">
            <img src="{{shopRes('/shop_img/car3.jpg')}}" alt="">
            <div class="name">
            兰博基尼 550-2
            </div>
          </div>
          <div class="option">
            <img src="{{shopRes('/shop_img/car4.jpg')}}" alt="">
            <div class="name">
              宾利添越
            </div>
          </div>
          <div class="option">
            <img src="{{shopRes('/shop_img/car5.jpg')}}" alt="">
            <div class="name">
              玛莎拉蒂GHIBLI（蓝色）
            </div>
          </div>
          <div class="option">
            <img src="{{shopRes('/shop_img/car6.jpg')}}" alt="">
            <div class="name">
              保时捷Panamera
            </div>
          </div>
      ...
      <div class="promise">
        ...
        <div class="promise_box clearfix">
          <div class="img_box f_l">
            <img src="{{shopRes('/shop_img/car7.png')}}" alt="">
          </div>

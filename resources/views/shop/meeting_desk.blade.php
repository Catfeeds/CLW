...
@section('body')
  ...
  <div class="proscenium_container">
    ...
    <!-- banner部分 -->
    <div class="banner" style="background: url('{{shopRes('/shop_img/proscenium_back.jpg')}}') no-repeat center;">
      <div class="title">办公家具 (会议桌)</div>
    ...
    <div class="color">
      <div class="title">
        ...
        <img src="{{shopRes('/shop_img/title_back.png')}}" alt="">
      </div>
    ...
    <!-- 前台描述部分 -->
    <div class="proscenium_des" style="background:url('{{shopRes('/shop_img/meeting_desk_banner.jpg')}}')">
      <div class="eng_title">SIMPLE  BUT  NOT  SIMPLE</div>
      <div class="zn_title">简约却不简单超越平凡</div>
      <div class="title2">
        黑色和白色的搭配一直是时尚大师们至爱的简洁色彩，以不变的态度看万变的世界，生活也是如此  
      </div>
    </div>
    <!-- 产品展示部分 -->
    <div class="proscenium_show">
      ...
      <div class="products">
        <div class="left">
          <img src="{{shopRes('/shop_img/meeting_desk_show1.jpg')}}" alt="">
        </div>
        <div class="right">
          <div class="right_top">
            <img src="{{shopRes('/shop_img/meeting_desk_show2.jpg')}}" alt="">
          </div>
          <div class="right_bottom">
            <img src="{{shopRes('/shop_img/meeting_desk_show3.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>

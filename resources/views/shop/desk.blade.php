...
@section('body')
  ...
  <div id="appointment">
    ...
    <!-- 前台描述部分 -->
    <div class="proscenium_des" style="background:url('{{shopRes('/shop_img/desk_des_back.jpg')}}')">
    ...
    <div class="proscenium_show">
      ...
      <div class="products">
        <div class="left">
          <img src="{{shopRes('/shop_img/desk_detail3.jpg')}}" alt="">
        </div>
        <div class="right">
          <div class="right_top">
            <img src="{{shopRes('/shop_img/desk_detail2.jpg')}}" alt="">
          </div>
          <div class="right_bottom">
            <img src="{{shopRes('/shop_img/desk_detail1.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>

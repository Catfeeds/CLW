...
@section('body')
    ...
    <div class="plant_container">
      ...
      <div class="plant_archives clearfix">
        <div class="img_box">
          <img src="/shop_img/plants_img_happiness1.jpg" alt="">
        </div>
      ...
      <div class="plant_put">
        ...
        <div class="plants_img">
          <img src="/shop_img/plants_img_happiness2.jpg" alt="">
          <img src="/shop_img/plants_img_happiness3.jpg" alt="">
          <img src="/shop_img/plants_img_happiness4.jpg" alt="">
        </div>
      </div>
      <div class="us_serve">

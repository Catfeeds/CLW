      ...
      <div class="list_container">
        ...
        <div class="select_area">
          ...
          <div class="select_option serve_select clearfix">
            ...
            <ul class="select_details clearfix f_l">
              <li class="f_l select_detail"><a  href="javascript:void(0)" class="@if($finance=='1') current @endif" href="javascript:void(0)">小规模记账</a></li>
              <li class="f_l select_detail"><a href="javascript:void(0)" class="@if($finance=='2') current @endif" href="javascript:void(0)">一般纳税人代理记账</a></li>
            </ul>
          </div>
          <div class="select_option serve_select clearfix">
            <div class="select_title f_l">工商代办：</div>
            <ul class="select_details clearfix f_l">
              <li class="f_l select_detail"><a href="javascript:void(0)" class="@if($finance=='3') current @endif" href="javascript:void(0)">有限责任公司注册</a></li>

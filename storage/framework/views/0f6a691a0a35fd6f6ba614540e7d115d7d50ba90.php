					...
					<div>
						<div class="titles" style="border-shadow:0;">
							...
							<div style="margin-left:-15px;">
								<div>
									<h5><img src="/we_img/house_detail_address.png"><?php echo e($data->address); ?></h5>
								</div>
							</div>
							<!--<div>
								<div>
						...
						<!--4最下推荐-->
						<house-detail-list title="<?php echo e($data->name); ?>" :api='1' building ='<?php echo e($data->id); ?>'></house-detail-list>
						<!--5交通及周边配套-->

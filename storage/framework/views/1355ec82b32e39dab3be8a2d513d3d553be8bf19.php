...
<?php $__env->startSection('header'); ?>
    <link rel="stylesheet" href="<?php echo e(res('/css/we_building_detail.css')); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('body'); ?>
	<div id="pullrefresh" class="mui-content">
	<input id="features" value="<?php echo e($data->feature_name_pic); ?>" type="hidden" />
	<input id="imgList" value="<?php echo e($data->pic_url); ?>" type="hidden"/>
		<input id="gps" value='{"lng": <?php echo e($data->gps[0]); ?>, "lat": <?php echo e($data->gps[1]); ?> }' type="hidden"/>
		<div id="Vuebuilding">
					...
					<div>
							...
							<div class="uls" style="padding-left:0;padding-right:0;">
								<div class="mui-row">
									<div class="mui-col-xs-4 bor"style="padding-right:10px;border:none !important;">
										<h3 style="font-size:17px;color:#333333;text-align:center;"><?php echo e($data->unit_price); ?></h3>
									...
									<div class="mui-col-xs-4 bor"style="border-left:1px solid #f4f4f4;border-right:1px solid #f4f4f4">
										<h3 style="font-size:17px;color:#333333;text-align:center;"><?php echo e($data->total_price); ?></h3>
										<h5 style="text-align:center;">万元/月</h5>
									</div>
									<div class="mui-col-xs-4 las">
										<h3 style="font-size:17px;color:#333333"><?php echo e($data->constru_acreage); ?></h3>
										<h5>面积(㎡)</h5>
									</div>
								</div>
							</div>
							<div style="margin-left:-15px;">
								<div>
									<h5 style="display: flex;">
										...
										<div style="line-height: 20px;"><?php echo e($data->address); ?></div>
									</h5>
								</div>
							</div>
							<!--<div>
						...
						<div class="build_infor">
							...
							<div>
								<div class="mui-row">
									...
									<div class="mui-col-xs-8" style="color:#333333"><h4><?php echo e($data->developer); ?></h4></div>
								</div>
								<div class="mui-row">
									<div class="mui-col-xs-4"><h4>建筑年代</h4></div>
									<div class="mui-col-xs-7" style="color:#333333"><h4><?php echo e($data->years_cn); ?></h4></div>
								</div>
								<div class="mui-row">
									<div class="mui-col-xs-4"><h4>总建筑面积</h4></div>
									<div class="mui-col-xs-8" style="color:#333333"><h4><?php echo e($data->acreage_cn); ?></h4></div>
								</div>
								<div class="mui-row">
									<div class="mui-col-xs-4"><h4>楼座数量</h4></div>
									<div class="mui-col-xs-8" style="color:#333333"><h4><?php echo e($data->building_block_num_cn); ?></h4></div>
								</div>
								<div class="mui-row">
									<div class="mui-col-xs-4"><h4>车位数量</h4></div>
									<div class="mui-col-xs-8" style="color:#333333"><h4><?php echo e($data->parking_num_cn); ?></h4></div>
								</div>
								<div class="mui-row">
									<div class="mui-col-xs-4"><h4>停车费</h4></div>
									<div class="mui-col-xs-8" style="color:#333333"><h4><?php echo e($data->parking_fee_cn); ?></h4></div>
								</div>
								<div class="mui-row">
									<div class="mui-col-xs-4"><h4>绿化率</h4></div>
									<div class="mui-col-xs-8" style="color:#333333"><h4><?php echo e($data->greening_rate_cn); ?></h4></div>
								</div>
								<div class="mui-row">
									<div class="mui-col-xs-4"><h4>入驻企业</h4></div>
									<div class="mui-col-xs-8" style="color:#333333"><h4><?php echo e($data->company_cn); ?></h4></div>
								</div>
								</div>
							</div>
						<!--3楼盘介绍-->
						<div class="advantage">
							...
							<div style="text-indent:23px;font-size:13px;color:rgb(153,153,153);text-align: justify;text-justify: inter-ideograph;line-height:26px;">
								<?php echo e($data->describe); ?>

							</div>
						</div>
						<!--4最下推荐-->
						<house-detail-list title="写字楼出租" :api='1' building ='<?php echo e($data->id); ?>'></house-detail-list>
						<!--5交通及周边配套-->
						<div class="periphery" style="margin-top:-10px !important;">
							...
							<a href="/get_map/<?php echo e($data->id); ?>" style="display: block;width: 100%">
        ...
        <script src="<?php echo e(res('/js/we_building_detail.js')); ?>"></script>
<?php $__env->stopSection(); ?>

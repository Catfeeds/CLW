...
<?php $__env->startSection('header'); ?>
    <link rel="stylesheet" href="<?php echo e(res('/css/we_user_house_resources.css')); ?>">
...
<div class="mui-content">
            ...
            <div class="mui-row">
                <div class="mui-col-xs-6 area">
                    <div class="mui-row" id="down">
                        ...
                        <div class="mui-col-xs-2"><img style="width: 9px;height:5px;margin-bottom:3px;"src="<?php echo e(res('/we_img/house_detail_down.png')); ?>"></div>
                    </div>
                </div>
    ...
    <script src="<?php echo e(res('/js/we_user_house_resources.js')); ?>"></script> 
<?php $__env->stopSection(); ?>

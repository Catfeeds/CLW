...
<?php $__env->startSection('header'); ?>
    <link rel="stylesheet" href="<?php echo e(res('/css/we_building_index.css')); ?>">
...
<?php $__env->startSection('body'); ?>
        ...
        <div class="main-content" hidden>
            ...
            <?php if(!$data['data']->count()): ?>
                <div v-if="!list.length" class="nothing">
                    <img src="<?php echo e(res('/we_img/nothing.png')); ?>">
    ...
    <script src="<?php echo e(res('/js/we_building_index.js')); ?>"></script>
<?php $__env->stopSection(); ?>

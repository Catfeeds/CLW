	...
	<div class="pullrefresh" id="Vuehouse">
			<div class="mui-content" id="vueContent">
				...
				<div id="VueMain">
					...
					<div style="padding-right: 15px;">
						<div>
							<h5><img src="/we_img/house_detail_address.png"><?php echo e($house->address); ?></h5>
						</div>
					</div>
							<!--<div>
								<div>
		...
		<ul class="mui-table-view secondCard" style="border-top:10px solid #f4f4f4;">
				...
				<a style="line-height:40px;color:#333333;" class="mui-navigate-right top" onclick="showInfo()">&nbsp;&nbsp;&nbsp;栋座信息</a>
					<div class="mui-collapse-content">
						...
						<div class="mui-row">
							...
							<div class="mui-col-xs-8"><h4><?php echo e($house->floor_num); ?></h4></div>
						</div>
					</div>
				</li>
			</ul>
			...
			<!--4交通及周边配套-->
				...
				<!--5最下推荐-->
				<house-detail-list :api='2' building ='<?php echo e($house->id); ?>' style="margin-bottom:65px;"></house-detail-list>
				<!-- 预约看房弹框 -->
			</div>
				...
				<footer id="footer" class="mui-row">
					...
					<?php else: ?>
						<div class="collect mui-col-xs-2 js_collect pointer">
							...
							<img src="/we_img/detail_colletc1.png" <?php if(!$house->collection): ?> class="mui-hidden" <?php endif; ?>  id="collect2">
							
							<img src="/we_img/detail_collect.png" <?php if($house->collection): ?> class="mui-hidden" <?php endif; ?> id="collect1"><span>收藏</span>
						</div>
					<?php endif; ?>

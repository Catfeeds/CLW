<<<<<<< HEAD
webpackJsonp([17],{107:function(e,t,s){e.exports=s(108)},108:function(e,t,s){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=s(2),o=(s.n(n),s(1));s.n(o);window.$=window.jQuery=s(0);var a=$("#tel"),r=$("#sms"),i=$("#getSms"),c=$("#password");$(document).on("touchend || tap","#getSms",function(e){if(!a.val()||""===a.val().trim())return Object(o.Toast)({message:"请输入手机号码",position:"center",duration:2e3}),!1;var t=a.val()+"/retrieve_password";$.ajax({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},url:"/sms/captcha/"+t,type:"get",success:function(e){if(e.success){i.html("120s");var t=setInterval(function(){i.html(parseInt(i.html())-1+"s"),parseInt(i.html())||(i.html("获取验证码"),window.clearInterval(t))},1e3);Object(o.Toast)({message:"短信发送成功",position:"center",duration:2e3})}},error:function(e){Object(o.Toast)({message:e.responseJSON.message,position:"center",duration:2e3})}})}),$(document).on("touchend || tap",".loginBtn button",function(e){var t=a.val(),s=r.val(),n=c.val();return t&&""!==t.trim()?s&&""!==s.trim()?n&&""!==n.trim()?n.length<6||n.length>18?(Object(o.Toast)({message:"密码长度必须在6-18位之间",position:"center",duration:2e3}),!1):void $.ajax({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},url:"/retrieve_pwd",type:"post",data:{tel:t,smsCode:s,password:n},success:function(e){Object(o.Toast)({message:e.message,position:"center",duration:2e3}),e.success&&(window.location.href="/user")},error:function(e){Object(o.Toast)({message:e.responseJSON.message,position:"center",duration:2e3})}}):(Object(o.Toast)({message:"请输入密码",position:"center",duration:2e3}),!1):(Object(o.Toast)({message:"请输入验证码",position:"center",duration:2e3}),!1):(Object(o.Toast)({message:"请输入手机号码",position:"center",duration:2e3}),!1)})}},[107]);
=======
webpackJsonp([18],{

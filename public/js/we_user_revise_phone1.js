<<<<<<< HEAD
webpackJsonp([10],{128:function(e,t,s){e.exports=s(129)},129:function(e,t,s){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=s(2),o=(s.n(n),s(1));s.n(o);window.$=window.jQuery=s(0);var a=$(".tel").html(),c=a.slice(0,3)+"****"+a.slice(7);$(".tel").html(c),$(document).on("touchend || tap","#getSms",function(){var e=a+"/reset_tel";$.ajax({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},url:"/sms/captcha/"+e,type:"get",success:function(e){if(e.success){getSms.html("120s");var t=setInterval(function(){getSms.html(parseInt(getSms.html())-1+"s"),parseInt(getSms.html())||(getSms.html("获取验证码"),window.clearInterval(t))},1e3);Object(o.Toast)({message:"短信发送成功",position:"center",duration:2e3})}},error:function(e){Object(o.Toast)({message:e.message,position:"center",duration:2e3})}})}),$(document).on("touchend || tap",".loginOut",function(){var e=$("#setSms").val();$.ajax({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},url:"/old_tel_validate",type:"post",data:{tel:a,smsCode:e},success:function(e){var t=Object(o.Toast)({message:e.message,position:"center",duration:5e3});setTimeout(function(){t.close(),window.location.href="/reset_tel_view"},2e3)},error:function(e){Object(o.Toast)({message:e.message,position:"center",duration:5e3})}})})}},[128]);
=======
webpackJsonp([10],{

<<<<<<< HEAD
webpackJsonp([8],{132:function(e,o,t){e.exports=t(133)},133:function(e,o,t){"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n=t(1),s=(t.n(n),t(2));t.n(s);window.$=window.jQuery=t(0);var c=$("#tel").html();console.log("ceshi",c);var i=c.slice(0,3)+"****"+c.slice(7);$("#tel").html(i),$(document).on("touchend || tap","#revisePwd",function(){window.location.href="/revise_password"}),$(document).on("touchend || tap","#reviseTel",function(){window.location.href="/old_tel_validate_view"}),$(document).on("touchend || tap",".loginOut",function(){$.ajax({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},url:"/logout",type:"get",success:function(e){console.log(11111111);var o=Object(n.Toast)({message:e.message,position:"center",duration:5e3});setTimeout(function(){o.close(),window.location.href="/user"},2e3)},error:function(e){Object(n.Toast)({message:e.message,position:"center",duration:5e3})}})})}},[132]);
=======
webpackJsonp([8],{

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__request__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__auth__ = __webpack_require__(10);
/**
 * Created by zxz1992 on 2018/5/22.
 */


var request = Object(__WEBPACK_IMPORTED_MODULE_0__request__["a" /* default */])();
...
function Ajax() {
  ...
  service.interceptors.request.use(function (config) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_1__auth__["a" /* getCookie */])('access_token')) {
      config.headers['Authorization'] = 'Bearer ' + Object(__WEBPACK_IMPORTED_MODULE_1__auth__["a" /* getCookie */])('access_token'); // 让每个请求携带自定义token 请根据实际情况自行修改
    }
    return config;
  }, function (error) {
